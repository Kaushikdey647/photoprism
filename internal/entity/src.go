...
// SrcGenerated contains sources that are commonly used for data generated by computer vision models and services.
var SrcGenerated = Priorities{
	SrcMarker: SrcPriority[SrcMarker],
	SrcImage:  SrcPriority[SrcImage],
	SrcPigo:   SrcPriority[SrcPigo],
	SrcONNX:   SrcPriority[SrcONNX],
	SrcOllama: SrcPriority[SrcOllama],
	SrcOpenAI: SrcPriority[SrcOpenAI],
...
// Report generates a metadata documentation report for sources with a description.
